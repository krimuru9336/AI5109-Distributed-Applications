...
public class BaseActivity extends AppCompatActivity {
    protected final String[] permissionsRecord = { Manifest.permission.VIBRATE, Manifest.permission.RECORD_AUDIO,
            Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE };
    protected final String[] permissionsContact = { Manifest.permission.READ_CONTACTS,
            Manifest.permission.WRITE_EXTERNAL_STORAGE };
    protected final String[] permissionsStorage = { Manifest.permission.READ_EXTERNAL_STORAGE,
            Manifest.permission.WRITE_EXTERNAL_STORAGE };
                ...
                try {
                    if (FirebaseAuth.getInstance().getCurrentUser() == null) {
                        if (getClass().getSimpleName().equalsIgnoreCase("LoginActivity")
                                || getClass().getSimpleName().equalsIgnoreCase("RegisterActivity")) {
                        } else {
    ...
    public void showProgress() {
        try {
            ...
            pd.setMessage(getString(R.string.msg_for_please_wait));
            pd.show();
        } catch (Exception e) {
            Utils.getErrors(e);
        }
