...
baseUrl = "https://17f6-2405-201-1004-1aeb-9869-b419-899e-4b66.ngrok-free.app"
    ...
    try:
        ...
        for message in result:
            ...
            if message_id not in unique_messages:
                ...
                image = f"{baseUrl}/uploaded_media/{message['message_text']}" if message["message_type"] != MessageType.text else ''
...
async def upload_media(
    ...
    if(message_type is not None):
        ...
        with open(f"uploaded_media/{uniqueFileName}", "wb") as f:
            f.write(file)
            f.close()
