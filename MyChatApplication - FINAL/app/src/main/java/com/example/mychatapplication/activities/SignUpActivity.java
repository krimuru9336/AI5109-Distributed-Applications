...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        final DocumentReference newUserRef = database.collection(Constants.KEY_COLLECTION_USERS).document();
        user.put(Constants.KEY_USER_ID,newUserRef.getId());
        newUserRef.set(user)
                .addOnSuccessListener(documentReference -> {
                    loading(false);
                    preferenceManager.putBoolean(Constants.KEY_IS_SIGNED_IN, true);
                    preferenceManager.putString(Constants.KEY_USER_ID, newUserRef.getId());
