...
public class RegisterActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // mTxtExistingUser.setText(HtmlCompat.fromHtml(getString(R.string.ExistingUser),
        // HtmlCompat.FROM_HTML_MODE_LEGACY));
        Utils.setHTMLMessage(mTxtExistingUser, getString(R.string.ExistingUser));
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btnRegister) {
            String user_Email = mTxtEmail.getText().toString().trim();
            String Username = mTxtUsername.getText().toString().trim();
            String user_Password = mTxtPassword.getText().toString().trim();

            if (TextUtils.isEmpty(user_Email) || TextUtils.isEmpty(Username) || TextUtils.isEmpty(user_Password)) {
                screens.showToast(R.string.AllFieldsRequired);
            } else if (!Utils.isValidEmail(user_Email)) {
                screens.showToast(R.string.strInvalidEmail);
            } else {
                register(user_Email, Username, user_Password);
            }
