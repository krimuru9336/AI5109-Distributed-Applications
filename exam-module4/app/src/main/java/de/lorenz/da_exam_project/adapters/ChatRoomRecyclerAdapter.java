...
import de.lorenz.da_exam_project.listeners.ChatMessageLongClickListener;
...
public class ChatRoomRecyclerAdapter extends FirestoreRecyclerAdapter<ChatMessage, ChatRoomRecyclerAdapter.ChatRoomModelViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull ChatRoomModelViewHolder holder, int position, @NonNull ChatMessage model) {
        ...
        holder.rightChatTextView.setLongClickable(true);
        ChatMessageLongClickListener chatMessageLongClickListener = new ChatMessageLongClickListener(context, holder.rightChatTextView, model);
        holder.rightChatTextView.setOnLongClickListener(chatMessageLongClickListener);
    }
