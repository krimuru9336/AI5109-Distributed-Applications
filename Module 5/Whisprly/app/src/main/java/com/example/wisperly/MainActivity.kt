...
import com.example.wisperly.ui.AppViewModel
import com.example.wisperly.ui.BottomBar
import com.example.wisperly.ui.Destination
import com.example.wisperly.ui.TopBar
import com.example.wisperly.ui.screens.AuthScreen
import com.example.wisperly.ui.screens.ChatScreen
import com.example.wisperly.ui.screens.FriendsScreen
import com.example.wisperly.ui.screens.GroupChatScreen
import com.example.wisperly.ui.screens.GroupsScreen
import com.example.wisperly.ui.screens.ImageScreen
import com.example.wisperly.ui.screens.VideoScreen
            ...
            if (signedIn) {
                TopBar(
                    title = when (backStackEntry?.destination?.route) {
                        Destination.Friends.name -> "Whisprly"
                        Destination.Chat.name -> appState.currentFriend ?: "Loading..."
                        Destination.Image.name -> "Image Viewer"
                        Destination.Video.name -> "Video Player"
                        Destination.Groups.name -> "Whisprly"
