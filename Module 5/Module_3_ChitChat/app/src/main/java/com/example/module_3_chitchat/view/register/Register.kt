...
fun RegisterView(
    ...
    Box(
        ...
        Column(
            ...
            Buttons(title = "Register", onClick = {registerViewModel.registerUser(chats = chats)}, backgroundColor = MaterialTheme.colorScheme.primary, textColor = MaterialTheme.colorScheme.onPrimary,
                modifier = Modifier
                    .fillMaxWidth(0.66f)
            )
