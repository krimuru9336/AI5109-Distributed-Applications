# SimpleChat Android App

SimpleChat is a basic text messaging app built using Kotlin and Android Studio. It allows users to view a list of available users on the app and start chatting with selected users.
