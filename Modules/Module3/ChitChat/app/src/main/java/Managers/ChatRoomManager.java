...
public class ChatRoomManager {
    ...
    public void searchOrCreateChatRoom(String enteredUsername, Consumer<ChatRoom> success) {
        ...
        // Query to check if the chat room with the entered username exists
    ...
    private void createNewChatRoom(String enteredUsername, Consumer<ChatRoom> success) {
        ...
        UserRef.orderByChild("name").equalTo(enteredUsername).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        // Perform actions with the new chat room
        // e.g., startActivity(new Intent(context, ChatActivity.class).putExtra("roomId", roomId));
    }
}
