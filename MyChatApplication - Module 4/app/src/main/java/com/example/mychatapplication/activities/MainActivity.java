...
import com.example.mychatapplication.adapters.RecentConversationAdapter;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if (value != null){
                ...
                if (documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    for (int i=0; i< conversations.size(); i++){
                        ...
                        if (conversations.get(i).senderId.equals(senderId)&& conversations.get(i).recieverId.equals(receiverId)){
                            ...
                            conversations.get(i).dateObjects = documentChange.getDocument().getDate(Constants.KEY_TIMESTAMP);
                            break;
                        }
                    }
            ...
            Collections.sort(conversations, (obj1, obj2) -> obj2.dateObjects.compareTo(obj1.dateObjects));
