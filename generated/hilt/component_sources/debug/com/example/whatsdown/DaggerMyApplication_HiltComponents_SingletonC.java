...
import com.example.whatsdown.data.AppModule_ProvideFirestoreFactory;
import com.example.whatsdown.ui.AppViewModel;
import com.example.whatsdown.ui.AppViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return ImmutableMap.<String, javax.inject.Provider<ViewModel>>of("com.example.whatsdown.ui.AppViewModel", ((Provider) appViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.whatsdown.ui.AppViewModel 
          return (T) new AppViewModel(singletonCImpl.provideFirestoreProvider.get());
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) AppModule_ProvideFirestoreFactory.provideFirestore(singletonCImpl.appModule);
