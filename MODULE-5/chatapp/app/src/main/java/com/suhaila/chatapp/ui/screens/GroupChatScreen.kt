                ...
                items(messages) { message ->
                    ...
                    Box(
                        modifier = modifier
                            .fillMaxWidth()
                            .padding(top = 8.dp),
                        contentAlignment = if (isCurrentUserSender) Alignment.CenterEnd else Alignment.CenterStart
                    ) {
                        Card(
                            modifier = modifier
                                .fillMaxWidth(0.7f)
                                .wrapContentWidth(if (isCurrentUserSender) Alignment.End else Alignment.Start)
                                .combinedClickable(
